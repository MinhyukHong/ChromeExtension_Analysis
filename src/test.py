...
API_CATEGORIES = {
    "Clipboard": ["navigator.clipboard.readText", "navigator.clipboard.writeText", "document.execCommand('paste')", "document.execCommand('copy')"],
    "Downloads": ["chrome.downloads.download", "chrome.downloads.search", "chrome.downloads.open", "chrome.downloads.erase", "chrome.downloads.removeFile"],
    "Storage": ["chrome.storage.local.get", "chrome.storage.local.set", "chrome.storage.sync.get", "chrome.storage.sync.set", "indexedDB.open", "localStorage.setItem", "sessionStorage.getItem", "navigator.storage.persist"],
    "Tabs": ["chrome.tabs.create", "chrome.tabs.query", "chrome.tabs.update", "chrome.tabs.get", "chrome.tabs.remove", "chrome.tabs.executeScript", "chrome.tabs.onUpdated.addListener", "chrome.tabs.onActivated.addListener", "chrome.tabs.captureVisibleTab"],
    "Scripting": ["chrome.scripting.executeScript", "chrome.scripting.insertCSS", "chrome.scripting.removeCSS", "chrome.scripting.registerContentScripts"],
    "Identity": ["chrome.identity.getAuthToken", "chrome.identity.getProfileUserInfo", "chrome.identity.launchWebAuthFlow"],
    "WebRequest": ["chrome.webRequest.onBeforeRequest", "chrome.webRequest.onHeadersReceived", "chrome.webRequest.onCompleted"], # 리스너 추가 형태를 대표 패턴으로
    "Bookmarks": ["chrome.bookmarks.create", "chrome.bookmarks.get", "chrome.bookmarks.search", "chrome.bookmarks.update", "chrome.bookmarks.remove"],
    "History": ["chrome.history.search", "chrome.history.addUrl", "chrome.history.deleteUrl", "chrome.history.deleteAll"],
    "Alarms": ["chrome.alarms.create", "chrome.alarms.get", "chrome.alarms.clear", "chrome.alarms.onAlarm.addListener"],
    "Notifications": ["chrome.notifications.create", "chrome.notifications.update", "chrome.notifications.clear", "chrome.notifications.onClicked.addListener"],
    "Context Menus": ["chrome.contextMenus.create", "chrome.contextMenus.update", "chrome.contextMenus.remove", "chrome.contextMenus.onClicked.addListener"],
    # ... 기타 카테고리 및 대표 API 패턴 추가 ...
     "FileSystem": ["document.querySelector", "FileReader.readAsText", "document.cookie"], # 예시
     "Network": ["fetch", "new XMLHttpRequest", "new WebSocket"], # 예시
     "Device": ["navigator.geolocation.getCurrentPosition", "navigator.mediaDevices.getUserMedia"], # 예시
     "System": ["chrome.system.cpu.getInfo", "chrome.management.getAll"], # 예시
}
